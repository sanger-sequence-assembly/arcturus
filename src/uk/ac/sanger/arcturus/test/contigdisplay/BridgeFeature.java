...
public class BridgeFeature implements Feature {
    ...
    public Object getClientObject() { return bridge; }

    public String toString() {
	return "BridgeFeature[bridge=" + bridge +
	    ", leftcontig=" + leftContigFeature.getClientObject() +
	    ", rightcontig=" + rightContigFeature.getClientObject() +
	    "]";
    }
    ...
    public ContigFeature getLeftContigFeature() { return leftContigFeature; }

    public ContigFeature getRightContigFeature() { return rightContigFeature; }
}
