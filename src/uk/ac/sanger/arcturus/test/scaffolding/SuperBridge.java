...
class SuperBridge extends Core {
	...
	public SuperBridge(int template_id, int silow, int sihigh, Link linka,
			Link linkb) {
	...
	public String toString() {
		return "SuperBridge[template_id=" + template_id + ", silow=" + silow
				+ ", sihigh=" + sihigh + ", linka=" + linka + ", linkb="
				+ linkb + "]";
	}
}
