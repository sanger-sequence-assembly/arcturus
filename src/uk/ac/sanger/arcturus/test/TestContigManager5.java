...
public class TestContigManager5 implements ContigProcessor{
	...
	if (instance == null || organism == null || assemblyname == null || projectname == null) {
	...
	try {
	    ...
	    if (assembly == null) {
		System.err.println("Assembly \"" + assemblyname + "\" is not known");
		System.exit(1);
	    }
	    ...
	    if (project == null) {
		System.err.println("Project \"" + projectname + "\" is not known");
		System.exit(1);
	    }

	    int processed = adb.processContigsByProject(project.getID(), flags, minlen, this);
	...
	System.err.println("Contig " + contig.getID() + " : name=" + contig.getName() +
