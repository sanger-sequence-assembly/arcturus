...
public class TemplateManager extends AbstractManager {
     ...
     *
     * @param adb the ArcturusDatabase object to which this manager belongs.
     */
    ...
    /**
     * Returns a template identified by the specified name. If the template has not
     * already been loaded from the database, it is created from information in the database.
     *
     * @param name the name of the template which is required.
     *
    ...
    /**
     * Returns a template identified by the specified name. If the template has not
     * already been loaded from the database, it may optionally be created from information
     * in the database.
     *
     * @param name the name of the template which is required.
     * @param autoload if true, and the template has not already been loaded, a new template
     * object is created and registered, and this object is returned.
     *
     * @return the template identified by the specified name, or null if autoload is false
     * and the template has not already been loaded.
     */
     ...
     * already been loaded from the database, it is created from information in the database.
     *
     * @param id the identifer of the template which is required.
     *
     ...
     * in the database.
     *
     * @param id the identifier of the template which is required.
     * @param autoload if true, and the template has not already been loaded, a new template
     * object is created and registered, and this object is returned.
     *
     * @return the template with the specified identifier, or null if autoload is false
     * and the template has not already been loaded.
     */
    ...
    /**
     * If the template with the specified identifer already exists in the cache, it is returned.
     * Otherwise, a new template is created from the information supplied and added to the cache,
     * and this object is returned.
     *
     * @param id the identifier of the template.
     * @param name the name of the template.
     * @param ligation the ligation of the template.
     *
     * @return the template with the specified identifer. This template is returned from the cache
     * if it exists, otherwise a new template is created from the information supplied and added
     * to the cache.
     */
