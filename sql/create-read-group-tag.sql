DROP TABLE IF EXISTS `READGROUPTAG`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `READGROUPTAG` (
   ...
   KEY `read_group_id` (`read_group_id`),
	 CONSTRAINT `READGROUPTAG_ibfk_1` FOREIGN KEY (`import_id`) REFERENCES `IMPORTEXPORT` (`id`) ON DELETE CASCADE
