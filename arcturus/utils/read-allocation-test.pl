...
sub showUsage {
    ...
    print STDERR "\n";
    print STDERR "-workproject\t(wp) test for a particular project only\n";
    print STDERR "-inside\t\t(ip) test inside projects only\n";
    print STDERR "-between\t(bp) test between projects only\n";
    print STDERR "\n";
    ...
    print STDERR "-project\t(problemproject,pp) define the problems project explicitly\n";
