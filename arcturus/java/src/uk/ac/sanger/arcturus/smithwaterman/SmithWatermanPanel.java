...
public class SmithWatermanPanel extends JPanel {
    ...
    public void display(String subjectSequence, String querySequence, int sMatch, int sMismatch,
			int sGapInit, int sGapExt, boolean banded, int bandwidth) {
	...
	sw = SmithWaterman.calculateMatrix(subjectSequence, querySequence, smat, bandwidth);
	...
	public void setMatrix(SmithWatermanArrayModel sw, String subjectSequence, String querySequence) {
	    this.sw = sw;
	...
	protected void paintComponent(Graphics g) {
		...
		for (int column = firstColumn; column <= lastColumn; column++) {
		    ...
		    char baseB = Character.toUpperCase(querySequence.charAt(column));
