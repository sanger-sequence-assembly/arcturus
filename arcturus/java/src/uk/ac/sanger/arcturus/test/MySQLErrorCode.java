...
public class MySQLErrorCode {
    ...
    public final static int ER_UNKNOWN_TIME_ZONE                     = 1298;
    public final static int ER_WARN_INVALID_TIMESTAMP                = 1299;
    public final static int ER_INVALID_CHARACTER_STRING              = 1300;
    public final static int ER_WARN_ALLOWED_PACKET_OVERFLOWED        = 1301;
    public final static int ER_CONFLICTING_DECLARATIONS              = 1302;
}
