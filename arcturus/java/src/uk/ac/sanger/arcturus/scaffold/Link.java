...
public class Link {
    ...
    public Set getMappingsA() { return mappingsA; }

    public Set getMappingsB() { return mappingsB; }
    ...
    public void merge(ReadMapping mappinga, ReadMapping mappingb, GapSize newgapsize) {
	...
	return "Link[template=" + template.getName() + ", " + mappingsA.size() +
	    " A mappings, " + mappingsB.size() + " B mappings, gapsize=" + gapsize +
	    "]";
    }
}
