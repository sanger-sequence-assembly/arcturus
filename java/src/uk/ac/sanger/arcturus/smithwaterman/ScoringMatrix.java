...
public class ScoringMatrix {
    ...
    public ScoringMatrix(int scoreMatch, int scoreMismatch, int scoreGapInit, int scoreGapExtend) {
    ...
    public int getMatchScore() { return scoreMatch; }

    public int getMismatchScore() { return scoreMismatch; }

    public int getGapInitScore() { return scoreGapInit; }

    public int getGapExtendScore() { return scoreGapExtend; }
}
