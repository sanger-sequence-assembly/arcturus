...
public class ScaffoldParser {
	public static void main(String[] args) {
		...
		try {
			...
			displayconstructor = displayclass
		...
		try {
			final JComponent display = (JComponent) displayconstructor
	...
	private static void showUsage(PrintStream ps) {
		...
		ps
				.println("\t-class\tName of class of display component [default: ScaffoldTree]");
	}
}
