	...
	class MyHandler extends DefaultHandler {
		...
		public void endElement(String namespaceURI, String lName, // local
			...
			switch (type) {
				...
				case SUPERSCAFFOLD:
					System.out.print("SUPER " + superscaffoldID + " "
							+ scaffoldCount + " " + superContigCount + " "
							+ superContigLength);

					for (int i = 0; i < projectCount.length; i++)
						if (projectCount[i] > 0)
							System.out.print(" " + i + "," + projectCount[i]
									+ "," + projectLength[i]);
				...
				case SCAFFOLD:
					System.out.print("SCAFF " + scaffoldID + " " + contigCount
							+ " " + totalContigLength);

					for (int i = 0; i < scaffoldProjectCount.length; i++)
						if (scaffoldProjectCount[i] > 0)
							System.out.print(" " + i + ","
									+ scaffoldProjectCount[i] + ","
									+ scaffoldProjectLength[i]);
