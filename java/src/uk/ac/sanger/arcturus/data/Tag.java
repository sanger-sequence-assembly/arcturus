...
public class Tag extends Core implements Comparable {
	...
	public Tag(String samTagType, char samType, String gapTagType, int start, int tag_length, 
		...
		// in a PT tag, the first number is the start position and the second number is the end position
		// PT:Z:46;59;+;COMM;Note=Read tag created in Gap5 TEST.1
		// in a CT tag, the length of the dummy read is the start and the cigar string gives the length
		// 7916:*	768	Contig23278	3396	255	1M	*	0	0	*	*	CT:Z:U;REPT;Note=REP0038 auto-generated by REPTILE
